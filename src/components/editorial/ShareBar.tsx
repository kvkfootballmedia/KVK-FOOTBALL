...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://kvkfootball.fr';
...
export default function ShareBar({ title, slug }: ShareBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 py-5 border-y border-gray-100 my-8">
      <span className="text-[9px] font-black uppercase tracking-[0.25em] text-gray-400 mr-2 shrink-0">
        Partager
      </span>
      ...
      <button
        ...
        className={`
          flex items-center gap-1.5 px-3 h-8 rounded-full border text-[9px] font-black uppercase tracking-widest
          transition-all duration-200
          ${copied
