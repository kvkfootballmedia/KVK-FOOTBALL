...
-- FIXED: Tables d'abord, puis fonctions/triggers
-- ============================================================
...
-- 1.2 Categories (Rubriques/Sections)
...
-- 1.5 Teams (International clubs & national teams)
...
-- 1.7 Competitions (Leagues, Cups, International tournaments)
...
-- 1.12 Post Blocks (Multi-block editor)
...
-- 1.14 Player Stats (Match-by-match)
...
-- 1.15 Stories & Story Groups (Ephemeral content)
...
-- ============================================================
-- 2) MAINTENANT CRÉER LES FONCTIONS & TRIGGERS
-- ============================================================

-- 2.1 Auto-update timestamp
...
-- 2.2 Get user role from profiles (maintenant que la table existe)
...
-- 2.4 Auto-create profile on user creation
...
-- ========================================
-- TEAMS - Public read, write by editor/admin (API sync only)
-- ========================================
...
-- ========================================
-- PLAYERS - Public read, write by editor/admin (API sync only)
-- ========================================
...
-- ========================================
-- COMPETITIONS - Public read, write by editor/admin (API sync only)
-- ========================================
...
-- ========================================
-- MATCHES - Public read, write by editor/admin (API sync only)
-- ========================================
...
-- ========================================
-- STANDINGS - Public read, write by editor/admin (API sync only)
-- ========================================
...
-- ========================================
-- PLAYER_MATCH_STATS - Public read, write by editor/admin (API sync only)
-- ========================================
